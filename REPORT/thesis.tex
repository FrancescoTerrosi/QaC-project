...
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{Static Analysis Tools for LLVM Clang\xspace}
% use the right myDegree option
\newcommand{\myDegree}{Corso di Laurea Magistrale in Informatica\xspace}
%\newcommand{\myDegree}{
	%Corso di Laurea Specialistica in Scienze e Tecnologie 
	%dell'Informazione\xspace}
\newcommand{\myName}{Edoardo Dini, Francesco Terrosi\xspace}
\newcommand{\myFaculty}{
...
\include{Chapters/ClangAnalysis}
