...
- Controllare il check che sembrava duplicato (rispetto alle misra) ---> Uninit member var\newline
- Unused function --> falso positivo come sempre\newline
- In generale molti meno issues trovati (MOLTI meno)\newline
- Distribuzione omogenea sia per file che per check eccetto: unused function (false positive) - CIndex (il king)\newline
- Tool molto veloce ma che da' poche informazioni\newline
- Output non human-readable (xml)\newline
- Poca versatilita' rispetto ad Understand (anche rispetto alla navigazione sui dati)\newline
- No duplicati\newline
