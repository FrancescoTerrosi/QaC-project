...
Rapporto più o meno costante nel rateo $violazioni/righedicodice$\newline
Sempre gli stessi file in cima (a parte in AllChecks)\newline
CLang Static Analyzer nessuna violazione. È coerente che un software sviluppato seguendo delle metriche definite dal team di sviluppo non abbia violazioni delle metriche stesse.\newline
È coerente che utilizzando altre metriche vengano trovate millemila violazioni.\newline
In alcuni casi consapevole in altri no (es: commentare la variabile BUONO - mettere const ovunque RIP)\newline
Falsi positivi\newline
Duplicati\newline
